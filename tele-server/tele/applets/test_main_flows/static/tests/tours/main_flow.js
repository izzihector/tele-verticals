tele.define('test_main_flows.tour', function (require) {
"use strict";
...
// Edit first component
    ...
    mobile: true,
    trigger: ".modal-footer .btn-primary rounded-sm:contains('Save & Close')",
    extra_trigger: ".modal:not(.o_inactive_modal) .modal-title:contains('Vendor')",
    content: _t('Save & Close'),
    position: 'right',
}, {
    mobile: true,
    trigger: ".modal-footer .btn-primary rounded-sm:contains('Save')",
    ...
    mobile: false,
    trigger: ".modal-footer .btn-primary rounded-sm",
    content: _t('Save'),
    position: 'bottom',
}, {
...
...tour.stepUtils.mobileKanbanSearchMany2X('Product', 'the_flow.product'),
{
    ...
    mobile: true,
    trigger: ".modal-footer .btn-primary rounded-sm:contains('Save & New')",
    extra_trigger: ".modal:not(.o_inactive_modal) .modal-title:contains('Order Lines')",
    content: _t('Save & New'),
    position: 'right',
}, {
...
...tour.stepUtils.statusbarButtonsSteps('Send by Email', _t("Try to send it to email"), ".o_statusbar_status .btn-primary rounded-sm:contains('Quotation')"),
{
    ...
    trigger: ".modal-footer .btn-primary rounded-sm span:contains('Send')",
...
{
    trigger: ".o_form_button_save",
    extra_trigger: ".o_statusbar_status .btn-primary rounded-sm:contains('Sales Order')",
