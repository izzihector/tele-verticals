...
class TeleBaseChecker(checkers.BaseChecker):
    ...
    msgs = {
        'E8502': (
            ...
            'gettext-variable',
            'See https://www.tele.studio/documentation/15.0/developer/misc/i18n/translations.html#variables'
        )
    }
...
def register(linter):
    linter.register_checker(TeleBaseChecker(linter))
