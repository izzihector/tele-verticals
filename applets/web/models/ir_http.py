...
import tele
from tele import api, http, models
from tele.http import request
from tele.tools import file_open, image_process, ustr
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = tele.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.tele.studio/buy",
            "name": user.name,
            "username": user.login,
    ...
    def _content_image_get_response(self, status, headers, image_base64, model='ir.attachment',
        ...
        if not image_base64:
            ...
            if not (width or height):
                width, height = tele.tools.image_guess_size_from_field_name(field)
        try:
