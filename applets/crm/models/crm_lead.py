...
from tele import api, fields, models, tools, SUPERUSER_ID
from tele.applets.iap.tools import iap_tools
from tele.applets.mail.tools import mail_validation
...
from tele.tools import date_utils, email_re, email_split, is_html_empty
...
PLS_COMPUTE_BATCH_STEP = 50000  # tele.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
