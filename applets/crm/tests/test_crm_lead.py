...
from tele.applets.crm.models.crm_lead import PARTNER_FIELDS_TO_SYNC, PARTNER_ADDRESS_FIELDS_TO_SYNC
from tele.applets.crm.tests.common import TestCrmCommon, INCOMING_EMAIL
from tele.applets.phone_validation.tools.phone_validation import phone_format
from tele.exceptions import UserError
from tele.tests.common import Form, tagged, users
