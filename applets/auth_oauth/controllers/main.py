...
from tele import api, http, SUPERUSER_ID, _
from tele.exceptions import AccessDenied
from tele.http import request
from tele import registry as registry_get

from tele.applets.auth_signup.controllers.main import AuthSignupHome as Home
from tele.applets.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
    ...
    def oea(self, **kw):
        ...
        with registry.cursor() as cr:
            try:
                ...
                provider = env.ref('auth_oauth.provider_tele')
            except ValueError:
