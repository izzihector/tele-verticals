...
from tele import _, api, Command, fields, models
from tele.exceptions import UserError
from tele.osv import expression
from tele.tools.float_utils import float_compare, float_is_zero, float_round
from tele.tools.misc import clean_context, OrderedSet
...
class StockMove(models.Model):
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            doc.message_post(body=msg, author_id=telebot_id, subject=msg_subject)
