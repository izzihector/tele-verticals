...
from tele import tests
from tele.applets.test_event_full.tests.common import TestWEventCommon
from tele.tests.common import HOST
...
class TestWEventRegister(TestWEventCommon):
    ...
    def test_register(self):
        self.browser_js(
            '/event',
            'tele.__DEBUG__.services["web_tour.tour"].run("wevent_register")',
            'tele.__DEBUG__.services["web_tour.tour"].tours.wevent_register.ready',
            login=None
        )
