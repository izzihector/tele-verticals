...
from tele import fields, exceptions, tests
...
from tele.applets.test_mail.models.test_mail_models import MailTestActivity
from tele.tools import mute_logger
from tele.tests.common import Form, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('tele.applets.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('tele.applets.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('tele.applets.mail.models.mail_activity_mixin.datetime', MockedDatetime):
