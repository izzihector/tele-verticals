...
from tele.applets.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
...
from tele.tools import mute_logger, formataddr
...
class TestMessagePost(TestMailCommon, TestRecipients):
    ...
    def test_post_inactive_follower(self):
        # In some case telebot is follower of a record.
        # Even if it shouldn't be the case, we want to be sure that telebot is not notified
        (self.user_employee | self.user_admin).write({'notification_type': 'inbox'})
    ...
    @mute_logger('tele.applets.mail.models.mail_mail', 'tele.tests')
    ...
    def test_post_answer(self):
        ...
        self.assertSentEmail(
            ...
            [self.partner_1],
            references_content='tele-%d-mail.test.simple' % self.test_record.id,
    ...
    @mute_logger('tele.applets.mail.models.mail_mail', 'tele.applets.mail.models.mail_thread')
