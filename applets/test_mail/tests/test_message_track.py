...
from tele.applets.test_mail.tests.common import TestMailCommon, TestMailMultiCompanyCommon
...
class TestTracking(TestMailCommon):
    ...
    def test_create_partner_from_tracking_multicompany(self):
        ...
        with patch('tele.applets.mail.models.mail_thread.MailThread._message_track_post_template', patched_message_track_post_template):
...
class TestTrackingInternals(TestMailCommon):
    ...
    def test_track_groups(self):
        ...
        field.groups = 'base.group_tele_manager'
