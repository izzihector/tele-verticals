...
from tele.applets.test_mail.models.test_mail_models import MailTestTicket
...
from tele.tests.common import users, Form
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('tele.tests', 'tele.applets.mail.models.mail_mail')
    ...
    @mute_logger('tele.tests', 'tele.applets.mail.models.mail_mail', 'tele.models.unlink')
...
class TestComposerResultsComment(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('tele.models.unlink', 'tele.applets.mail.models.mail_mail')
