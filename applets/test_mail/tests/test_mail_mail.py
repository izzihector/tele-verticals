...
from tele import api, tools
from tele.applets.base.tests.common import MockSmtplibCase
from tele.applets.test_mail.tests.common import TestMailCommon
from tele.tests import common, tagged
from tele.tools import mute_logger, DEFAULT_SERVER_DATETIME_FORMAT
...
class TestMailMailRace(common.TransactionCase):
    ...
    def test_mail_bounce_during_send(self):
        ...
        def send_email(self, message, *args, **kwargs):
            with this.registry.cursor() as cr, mute_logger('tele.sql_db'):
                try:
