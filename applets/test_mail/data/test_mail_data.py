...
To: {to}
cc: {cc}
Received: by mail1.tele.studio (Postfix, from userid 10002)
...
Received: from mail-ie0-f173.google.com (mail-ie0-f173.google.com [209.85.223.173])
    ...
    for <raoul@telecms.fr>; Fri, 23 Aug 2013 13:17:55 +0200 (CEST)
...
From: "Bruce Wayne" <bruce@wayneenterprises.com>
Subject: test
Message-ID: <c0c20fdd-a38e-b296-865b-d9232bf30ce5@tele.studio>
...
From: {email_from}
To: {to}
References: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@tele.studio>
Message-ID: <cb7eaf62-58dc-2017-148c-305d0c78892f@tele.studio>
Date: Wed, 14 Mar 2018 14:26:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@tele.studio>
Content-Type: multipart/mixed;
...
Delivered-To: anon2@gmail1.tele.studio
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@tele.studio header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@tele.studio designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@tele.studio;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=tele.studio
Return-Path: <soup@tele.studio>
Received: from mail2.tele.studio (mail2.tele.studio. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@tele.studio designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.tele.studio (Postfix) with ESMTPSA id 7B571A4085
	for <what@tele.studio>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=tele.studio; s=mail;
...
To: what@tele.studio
From: Soup <soup@tele.studio>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@tele.studio>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.tele.studio
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.tele.studio">http://www.tele.studio</a> </pre>
  </body>
</html>
...
Delivered-To: tele+82240-account.invoice-19177@mycompany.example.com
...
MIME-Version: 1.0
Message-Id: {msg_id}
references: <1571814481.189281940460205.799582441238467-tele-19177-account.invoice@mycompany.example.com>
Subject: Test
...
X-Tele-Objects: account.invoice-19177
...
In-Reply-To: <829228111124527.1111111602.256611118262939-tele-129-xxxx.xxxx@ip-1-1-1-1>
References: <867911111953277.1523671337.187951111160400-tele-129-xxxx.xxxx@ip-1-1-1-1>
 <867911111953277.1523671337.256611118262939-tele-129-xxxx.xxxx@ip-1-1-1-1>
...
.256660938262939-tele-129-xxxx.xxxx@ip-1-1-1-1" type=3D"cite"=
 class=3D"cite2">
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.tele.studio">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
...
MIME-Version: 1.0
Message-Id: {extra}
references: <670034078674109.1555335454.587288856506348-tele-32-project.task@aaa>
Subject: Re: Test
From: Tele Admin <admin@yourcompany.example.com>
Reply-To: YourCompany Research & Development <aaa+catchall@test.ironsky>
To: Raoul <{email_from}>
Date: Mon, 15 Apr 2019 13:40:24 -0000
X-Tele-Objects: project.project-3, ,project.task-32
