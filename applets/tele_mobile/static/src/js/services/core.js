/* global TeleDeviceUtility */
tele.define('tele_mobile.core', function () {
"use strict";

var available = typeof TeleDeviceUtility !== 'undefined';
var DeviceUtility;
var deferreds = {};
var methods = {};

if (available){
    DeviceUtility = TeleDeviceUtility;
    delete window.TeleDeviceUtility;
}
 ...
 * @param {Object} result
 */
window.tele.native_notify = function (id, result) {
