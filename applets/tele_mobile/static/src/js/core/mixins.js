tele.define('tele_mobile.mixins', function (require) {
"use strict";

const session = require('web.session');
const mobile = require('tele_mobile.core');
...
tele.define('tele_mobile.hooks', function (require) {
"use strict";

const { backButtonManager } = require('tele_mobile.core');
 ...
 * on the mobile application of Tele. This actually replaces the default back
