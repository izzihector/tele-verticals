tele.define("tele_mobile.tests", function (require) {
    "use strict";
    ...
    } = require("tele_mobile.mixins");
    const mobile = require("tele_mobile.core");
    const UserPreferencesFormView = require("tele_mobile.UserPreferencesFormView");
    const { base64ToBlob } = require("tele_mobile.testUtils");
