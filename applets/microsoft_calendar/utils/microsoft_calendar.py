...
from tele.applets.microsoft_calendar.utils.microsoft_event import MicrosoftEvent
from tele.applets.microsoft_account.models.microsoft_service import TIMEOUT, RESOURCE_NOT_FOUND_STATUSES
...
class MicrosoftCalendarService():
    ...
    def _microsoft_authentication_url(self, from_url='http://www.tele.studio'):
    ...
    def _can_authorize_microsoft(self, user):
        return user.has_group('base.group_tele_manager')
