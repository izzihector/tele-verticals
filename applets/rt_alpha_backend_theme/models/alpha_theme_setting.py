...
import base64
URL = '/rt_alpha_backend_theme/static/src/scss/alpha_theme_variables.scss'
class RtAlphaThemeSettings(models.Model):
    """
    
    Customise the backend theme
    
    """

    _name = 'rt.alpha.theme.settings'
    ...
    alpha_sticky_tree_view = fields.Boolean(string="Sticky Tree View")
    alpha_one2many_field_tree_view = fields.Boolean(string="One2many Field Tree View")
    alpha_sticky_form_view_chatter = fields.Boolean(string="Sticky Form View Chatter")
    alpha_sticky_form_view_statusbar = fields.Boolean(string="Sticky Form View Statusbar")
    # alpha_sticky_pivot_view = fields.Boolean(string="Sticky Pivot View Statusbar")
    ...
    def action_apply_theme_settings(self):
        ...
        if self:
            content = """
            $rt_alpha_theme_color_type:%(rt_alpha_theme_color_type)s;
            $rt_alpha_theme_primary_1_color:%(rt_alpha_theme_primary_1_color)s;
            $rt_alpha_theme_primary_2_color:%(rt_alpha_theme_primary_2_color)s; 
            $rt_alpha_theme_secondary_color:%(rt_alpha_theme_secondary_color)s;                                  
            $rt_alpha_theme_background_type:%(rt_alpha_theme_background_type)s;              
            $rt_alpha_button_type:%(rt_alpha_button_type)s; 
            $rt_alpha_button_primary_1_color:%(rt_alpha_button_primary_1_color)s; 
            $rt_alpha_button_primary_2_color:%(rt_alpha_button_primary_2_color)s; 
            $rt_alpha_button_secondary_color:%(rt_alpha_button_secondary_color)s;   
            $rt_alpha_sidebr_type:%(rt_alpha_sidebr_type)s;
            $rt_alpha_sidebar_position:%(rt_alpha_sidebar_position)s;
            $rt_alpha_font_style:%(rt_alpha_font_style)s;
            $rt_alpha_checkbox_style:%(rt_alpha_checkbox_style)s;
            $rt_alpha_radion_btn_style:%(rt_alpha_radion_btn_style)s;
            $rt_alpha_theme_loading_type:%(rt_alpha_theme_loading_type)s;
            $rt_alpha_theme_scrollbar_style:%(rt_alpha_theme_scrollbar_style)s;
            $rt_alpha_theme_tab_style:%(rt_alpha_theme_tab_style)s;
            $rt_alpha_theme_form_style:%(rt_alpha_theme_form_style)s;

            
            $rt_alpha_theme_sticky_tree_view:%(rt_alpha_theme_sticky_tree_view)s;
            $rt_alpha_theme_one2many_field_tree_view:%(rt_alpha_theme_one2many_field_tree_view)s;
            $rt_alpha_theme_sticky_form_view_chatter:%(rt_alpha_theme_sticky_form_view_chatter)s;
            $rt_alpha_theme_sticky_form_view_statusbar:%(rt_alpha_theme_sticky_form_view_statusbar)s;
            
            $rt_alpha_theme_separator_style:%(rt_alpha_theme_separator_style)s;
            $rt_alpha_theme_popup_style:%(rt_alpha_theme_popup_style)s;
            $rt_alpha_theme_font_size:%(rt_alpha_theme_font_size)s;
            
            """ % {
            'rt_alpha_theme_color_type':self.theme_color_type,
            'rt_alpha_theme_primary_1_color':self.theme_primary_1_color,  
            'rt_alpha_theme_primary_2_color':self.theme_primary_2_color,
            'rt_alpha_theme_secondary_color':self.theme_secondary_color,                                              
            'rt_alpha_theme_background_type':self.theme_background_type, 
            # 'rt_alpha_theme_background_color':self.theme_background_color, 
            'rt_alpha_button_type':self.button_type, 
            # 'rt_alpha_button_color_type':self.button_color_type, 
            'rt_alpha_button_primary_1_color':self.button_primary_1_color, 
            'rt_alpha_button_primary_2_color':self.button_primary_2_color, 
            'rt_alpha_button_secondary_color':self.button_secondary_color,                                     
            # 'rt_alpha_is_use_google_font':self.is_use_google_font, 
            # 'rt_alpha_google_font_family':self.google_font_family,
            'rt_alpha_sidebr_type':self.sidebar_style,
            'rt_alpha_sidebar_position':self.sidebar_position,
            'rt_alpha_font_style':self.font_style,
            'rt_alpha_checkbox_style':self.checkbox_style,
            'rt_alpha_radion_btn_style':self.radio_btn_style,
            'rt_alpha_theme_loading_type':self.theme_loading_type,
            'rt_alpha_theme_scrollbar_style':self.theme_scrollbar_style,
            'rt_alpha_theme_tab_style':self.theme_tab_style,
            'rt_alpha_theme_form_style':self.theme_form_style,

            'rt_alpha_theme_sticky_tree_view':self.alpha_sticky_tree_view,
            'rt_alpha_theme_one2many_field_tree_view':self.alpha_one2many_field_tree_view,
            'rt_alpha_theme_sticky_form_view_chatter':self.alpha_sticky_form_view_chatter,
            'rt_alpha_theme_sticky_form_view_statusbar':self.alpha_sticky_form_view_statusbar,
            # 'rt_alpha_theme_sticky_pivot_view':self.alpha_sticky_pivot_view,
            'rt_alpha_theme_separator_style':self.theme_separator_style,
            'rt_alpha_theme_popup_style':self.theme_popup_style,
            'rt_alpha_theme_font_size':self.theme_font_size,
            }
            ...
            if custom_attachment.sudo():
                ...
                new_attach = {
                    'name': 'alpha_theme_variables.scss',
                    'type': "binary",
                    'mimetype': 'text/scss',
                    'datas': datas,
                    'url': URL,
