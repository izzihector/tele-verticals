...
from tele.applets.calendar.models.calendar_attendee import Attendee
from tele.applets.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from tele.tools import pycompat, html2plaintext, is_html_empty
...
class Meeting(models.Model):
    ...
    def default_get(self, fields):
        # super default_model='crm.lead' for easier use in applets
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Tele'
