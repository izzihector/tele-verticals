tele.define('im_livechat.legacy.im_livechat.im_livechat', function (require) {
"use strict";
...
var LivechatButton = Widget.extend({
    className: 'tele o_livechat_button d-print-none',
    custom_events: {
...
tele.define('im_livechat.legacy.im_livechat.model.WebsiteLivechat', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.im_livechat.model.WebsiteLivechatMessage', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.im_livechat.WebsiteLivechatWindow', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.model.AbstractThread', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.model.ThreadTypingMixin', function (require) {
"use strict";
...
var ThreadTypingMixin = {
     ...
     * how translation works in Tele, for which unevaluated string cannot be
     * translated.
     *
...
tele.define('im_livechat.legacy.mail.model.AbstractMessage', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.AbstractThreadWindow', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.model.CCThrottleFunctionObject', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.model.CCThrottleFunction', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.model.Timer', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.model.Timers', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.widget.Thread', function (require) {
"use strict";
...
tele.define('im_livechat.legacy.mail.DocumentViewer', function (require) {
"use strict";
