...
from tele.tests.common import TransactionCase, can_import
from tele.modules.module import get_module_resource
from tele.tools import mute_logger, pycompat
from tele.applets.base_import.models.base_import import ImportValidationError
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('tele.applets.base_import.models.base_import')
...
foo3,US,0,persons\n""",
    ...
    def test_multi_mapping(self):
        ...
        self.assertEqual('Tele Demo The Demo User', partners[1].name)
