...
from tele import _, api, fields, models, service
from tele.exceptions import ValidationError

from tele.applets.payment_mollie.const import SUPPORTED_CURRENCIES
...
class PaymentAcquirer(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        tele_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'tele/{tele_version} MollieNativetele/{module_version}',
        }
