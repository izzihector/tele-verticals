...
from tele import Command, fields
from tele.applets.mail.models.mail_channel import channel_avatar, group_avatar
from tele.applets.mail.tests.common import mail_new_test_user
from tele.applets.mail.tests.common import MailCommon
from tele.exceptions import AccessError
from tele.tests import tagged, Form
from tele.tests.common import users
from tele.tools import html_escape, mute_logger
...
class TestChannelAccessRights(MailCommon):
    ...
    @mute_logger('tele.applets.base.models.ir_rule', 'tele.applets.base.models.ir_model', 'tele.models')
    @users('user_public')
    ...
    @mute_logger('tele.applets.base.models.ir_rule', 'tele.models', 'tele.models.unlink')
    @users('employee')
    ...
    @mute_logger('tele.applets.base.models.ir_rule', 'tele.models')
    @users('user_portal')
...
class TestChannelInternals(MailCommon):
    ...
    @users('employee')
    @mute_logger('tele.applets.mail.models.mail_mail', 'tele.models.unlink')
