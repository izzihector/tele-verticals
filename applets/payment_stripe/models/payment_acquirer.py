...
from tele.applets.payment_stripe import utils as stripe_utils
from tele.applets.payment_stripe.const import API_VERSION, PROXY_URL, WEBHOOK_HANDLED_EVENTS
from tele.applets.payment_stripe.controllers.main import StripeController
from tele.applets.payment_stripe.controllers.onboarding import OnboardingController
...
class PaymentAcquirer(models.Model):
    ...
    stripe_webhook_secret = fields.Char(
        ...
        help="If a webhook is enabled on your Stripe account, this signing secret must be set to "
             "authenticate the messages sent from Stripe to Tele.",
    ...
    def action_stripe_connect_account(self, menu_id=None):
        ...
        the URL the user is redirected to when coming back on Tele after the onboarding. If the link
