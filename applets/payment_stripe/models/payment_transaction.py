...
from tele.applets.payment import utils as payment_utils
from tele.applets.payment_stripe import utils as stripe_utils
from tele.applets.payment_stripe.const import INTENT_STATUS_MAPPING, PAYMENT_METHOD_TYPES
    ...
    def _stripe_create_customer(self):
        ...
        customer = self.acquirer_id._stripe_make_request(
            'customers', payload={
                ...
                'description': f'Tele Partner: {self.partner_id.name} (id: {self.partner_id.id})',
