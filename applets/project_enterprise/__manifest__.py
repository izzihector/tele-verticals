...
Bridge module for project and enterprise
    ...
    'version': '1.0',
    'depends': ['project', 'web_map', 'web_gantt', 'tele_enterprise'],
    'data': [
    ...
    'assets': {
        ...
        'project.webclient': [
            ('remove', 'tele_enterprise/static/src/legacy/legacy_service_provider.js'),
            ('remove', 'tele_enterprise/static/src/webclient/home_menu/*'),
