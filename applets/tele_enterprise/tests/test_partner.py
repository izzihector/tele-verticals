...
from tele.tests.common import HttpCase, tagged
...
class TestPartnerVCard(HttpCase):
    ...
    def test_fetch_partner_vcard(self):
        res = self.url_open('/tele_enterprise/partner/%d/vcard' % self.partner.id)
    ...
    def test_not_exist_partner_vcard(self):
        ...
        self.partner.unlink()
        res = self.url_open('/tele_enterprise/partner/%d/vcard' % partner_id)
