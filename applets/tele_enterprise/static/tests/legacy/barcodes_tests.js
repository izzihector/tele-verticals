tele.define('tele_mobile.barcode.tests', function (require) {
    "use strict";
    ...
    const FieldMany2OneBarcode = require('tele_mobile.barcode_fields');
    const BarcodeScanner = require('@tele_enterprise/webclient/barcode/barcode_scanner');
    ...
    QUnit.module('tele_mobile', {
        ...
        QUnit.test("tele_mobile: barcode button in a mobile environment with single results", async function (assert) {
            assert.expect(2);
        ...
        QUnit.test("tele_mobile: barcode button in a mobile environment with multiple results", async function (assert) {
            assert.expect(4);
