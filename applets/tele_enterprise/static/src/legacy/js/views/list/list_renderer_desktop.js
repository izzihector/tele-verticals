tele.define('tele_enterprise.ListRenderer', function (require) {
    "use strict";
    ...
    const PromoteStudioDialog = require('tele_enterprise.PromoteStudioDialog');

    patch(ListView.prototype, 'tele_enterprise.ListView', {
    ...
    patch(ListRenderer.prototype, 'tele_enterprise.ListRenderer', {
        ...
        _renderOptionalColumnsDropdown: function () {
            ...
            if (session.is_system && this.isStudioEditable) {
                ...
                const $addCustomField = $(qweb.render('tele_enterprise.open_studio_button'));
