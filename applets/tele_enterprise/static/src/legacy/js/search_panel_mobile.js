tele.define("web.SearchPanelMobile", function (require) {
    "use strict";
    ...
    patch(SearchPanel.prototype, "tele_enterprise.SearchPanel.Mobile", {
        setup() {
    ...
    patch(SearchPanel, "tele_enterprise.SearchPanel.Mobile", {
        template: "tele_enterprise.Legacy.SearchPanel.Mobile",
        components: {
