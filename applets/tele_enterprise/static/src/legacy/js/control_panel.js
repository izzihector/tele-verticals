tele.define('tele_enterprise.ControlPanel', function (require) {
    "use strict";
     ...
     */
    patch(ControlPanel.prototype, 'tele_enterprise.ControlPanel', {
        setup() {
    ...
    patch(ControlPanel, 'tele_enterprise.ControlPanel', {
        template: 'tele_enterprise._ControlPanel',
        components: {
