tele.define('website_sale.add_product', function (require) {
'use strict';
...
tele.define('website_sale.editMenu', function (require) {
    'use strict';
...
tele.define('website_sale.editor', function (require) {
'use strict';
