...
from tele import fields, SUPERUSER_ID

from tele.tests import common, new_test_user
from tele.applets.hr_timesheet.tests.test_timesheet import TestCommonTimesheet
import time
...
class TestTimesheetHolidaysCreate(common.TransactionCase):
    ...
    def test_company_create(self):
        ...
        user = new_test_user(self.env, login='fru',
                             groups='base.group_user,base.group_tele_manager,base.group_partner_manager',
