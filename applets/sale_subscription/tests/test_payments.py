...
from tele.applets.sale_subscription.tests.common_sale_subscription import TestSubscriptionCommon
...
class TestSubscriptionPayments(PaymentCommon, TestSubscriptionCommon):
    ...
    def test_auto_payment_with_token(self):
        ...
        patchers = [
            patch(
                'tele.applets.sale_subscription.models.sale_subscription.SaleSubscription'
                '._do_payment',
        ...
        patchers[0].stop()
        failing_payment_patch = patch('tele.applets.sale_subscription.models.sale_subscription.SaleSubscription._do_payment', wraps=self._mock_subscription_do_payment_fail)
        ...
        with mute_logger('tele.applets.sale_subscription.models.sale_subscription'):
    ...
    def test_do_payment_calls_send_payment_request_only_once(self):
        ...
        with unittest.mock.patch(
            'tele.applets.payment.models.payment_transaction.PaymentTransaction'
