tele.define('sign.PDFIframe', function (require) {
    'use strict';
...
tele.define('sign.Document', function (require) {
    'use strict';
...
tele.define('sign.utils', function (require) {
    'use strict';
...
// Signing part
tele.define('sign.document_signing', function (require) {
    'use strict';
