tele.define('sign.views_custo', function(require) {
    'use strict';
...
tele.define('sign.template', function(require) {
    'use strict';
...
tele.define('sign.DocumentBackend', function (require) {
    'use strict';
    var AbstractAction = require('web.AbstractAction');
    var core = require('web.core');
...
tele.define('sign.document_edition', function(require) {
    'use strict';
...
tele.define('sign.document_signing_backend', function(require) {
    'use strict';
