# -*- coding: utf-8 -*-
from tele import api, Command, fields, models, _
from tele.osv import expression
from tele.exceptions import UserError, ValidationError
from tele.applets.base.models.res_bank import sanitize_account_number
from tele.tools import remove_accents
import logging
import re
import warnings
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('tele', 'Tele'), ('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the Tele reference.")
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of Tele.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of Tele.\n"
        "Check: Pay bills by check and print it from Tele.\n"
    ...
    alias_id = fields.Many2one('mail.alias', string='Email Alias', help="Send one separate email for each invoice.\n\n"
                                                                  ...
                                                                  "Only PDF and XML files will be interpreted by Tele", copy=False)
