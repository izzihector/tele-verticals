...
from tele import models, api, _, fields
from tele.osv import expression
from tele.release import version
from tele.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from tele.tools.misc import formatLang, format_date as tele_format_date, get_lang
import random
...
class account_journal(models.Model):
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': tele_format_date(self.env, activity.get('date_deadline'))
                }
    ...
    def get_line_graph_datas(self):
        ...
        color = '#875A7B' if 'e' in version else '#ccd2d491'
