...
from tele import api, fields, models, Command, _
from tele.exceptions import RedirectWarning, UserError, ValidationError, AccessError
from tele.tools import float_compare, float_is_zero, date_utils, email_split, email_re, html_escape, is_html_empty
from tele.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_tele_invoice(self):
        """ This computes the reference based on the Tele format.
    ...
    def _get_invoice_reference_tele_partner(self):
        """ This computes the reference based on the Tele format.
