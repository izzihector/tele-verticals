tele.define('tele_backend_theme.Ks_custom_action_menu.js', function (require) {
    "use strict";
    ...
    const KsDropdownMenu = require('tele_backend_theme.KsDropdownMenu');
    ...
    KsActionMenus.template = 'tele_backend_theme.KsActionMenus';
