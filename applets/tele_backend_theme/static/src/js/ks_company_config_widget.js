tele.define("tele_backend_theme.ks_company_config_widget", function(require) {
    "use strict";
       ...
       */
        ...
        _onInputChange: function(ev) {
            ...
            if (ev.currentTarget.name && !$(ev.currentTarget).hasClass("ks_binary_field")) {
                ...
                if(ev.currentTarget.value<=0.3){
                    document.getElementById("tele-drawer-comp-slider").classList.remove("d-none");
                }
                else{
                    if(document.getElementById("tele-drawer-comp-slider")){
                    document.getElementById("tele-drawer-comp-slider").classList.add("d-none");
                }}
                }
        ...
        _ksApplyTempColorTheme: function(field_name, field_val) {
            var ks_color_field_dict = {
                ...
                ks_menu_hover_company: "--tele-over-link",
