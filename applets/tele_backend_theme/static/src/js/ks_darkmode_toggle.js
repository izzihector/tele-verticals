tele.define("tele_backend_theme.Ks_darkmode_toggle", function(require) {
    "use strict";
    ...
    var quick_settings = require("tele_backend_theme.ks_quick_settings_widget")
...
//                );
       ...
       */
        ...
        _ksManageCurrentColorTheme(background) {
            ...
            } else if (session.ks_current_color_mode == "tele-dark" && ks_header_icon_clr == "white") {
            ...
            } else if (session.ks_current_color_mode == "tele-dark") {
                document.body.style.removeProperty("--tele-main-control-bg");
