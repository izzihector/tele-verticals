tele.define("tele_backend_theme.ks_appsmenu", function (require) {
  "use strict";
...
//    var { NavBar } = require("@web/webclient/navbar/navbar");
  ...
  patch(EnterpriseNavBar.prototype, "tele_backend_theme.ks_appsmenu", {
    setup() {
      this._super();
      useListener(
        "keydown",
...
//      this.$search_results = $(this.el).find(".tele-search-values");
...
//    },
    ...
    _ksSearchMenusList: function () {
      ...
      this.$search_results.html(
        QWeb.render("tele_backend_theme.ks_search_menu_items", {
    ...
    _ksSearchValuesMovement: function (ev) {
      var all = this.$search_results.find(".tele-menu-search-value"),
