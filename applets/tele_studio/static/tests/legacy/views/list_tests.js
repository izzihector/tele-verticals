...
import { registerStudioDependencies } from "@tele_studio/../tests/helpers";
import { studioLegacyService } from "@tele_studio/legacy/studio_legacy_service";
...
QUnit.module('Studio', (hooks) => {
    ...
    QUnit.test("add custom field button with other optional columns", async function (assert) {
        ...
        assert.containsOnce(webClient, '.o_studio .o_tele_studio_editor .o_list_view');
    });
