tele.define('tele_studio.ListRenderer', function (require) {
"use_strict";
...
// This is used to force tele_studio to load after tele_enterprise
require('tele_enterprise.ListRenderer');

patch(ListRenderer.prototype, 'tele_studio.ListRenderer', {
    /**
