...
class WebStudioReportController(main.WebStudioController):
    ...
    @http.route('/tele_studio/print_report', type='json', auth='user')
    ...
    @http.route('/tele_studio/edit_report', type='json', auth='user')
    ...
    @http.route('/tele_studio/read_paperformat', type='json', auth='user')
    def read_paperformat(self, report_id):
        report = request.env['ir.actions.report'].browse(report_id)
        return report.get_paperformat().read()

    @http.route('/tele_studio/get_widgets_available_options', type='json', auth='user')
    ...
    @http.route('/tele_studio/get_report_views', type='json', auth='user')
    ...
    @http.route('/tele_studio/edit_report_view', type='json', auth='user')
    ...
    @http.route('/tele_studio/edit_report_view_arch', type='json', auth='user')
    ...
    @http.route('/tele_studio/edit_report/test_load_assets', type='json', auth='user')
