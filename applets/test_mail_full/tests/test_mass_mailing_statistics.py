...
from tele.applets.test_mail_full.tests.test_mass_sms import TestMassSMSCommon
...
class TestMailingStatistics(TestMassSMSCommon):
    ...
    @mute_logger('tele.applets.mass_mailing_sms.models.mailing_mailing', 'tele.applets.mail.models.mail_mail', 'tele.applets.mail.models.mail_thread')
