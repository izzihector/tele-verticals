...
from tele.applets.resource.models.resource import float_to_time, HOURS_PER_DAY
from tele.exceptions import AccessError, UserError, ValidationError
from tele.tools import float_compare
from tele.tools.float_utils import float_round
...
class HolidaysRequest(models.Model):
    ...
    def _check_allocation_duration(self):
        # Deprecated as part of https://github.com/tele-studio/tele/pull/96545
        ...
        for holiday in holidays:
            if not self._context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from TeleBot (sudo)
