tele.define('mass_mailing.FieldHtml', function (require) {
'use strict';
...
var MassMailingFieldHtml = FieldHtml.extend({
    ...
    _switchThemes: function (themeParams) {
        ...
        this.wysiwyg.teleEditor.historyStep(true);
    },
    ...
    _onLoadWysiwyg: function () {
        ...
        this._super();
        this.wysiwyg.teleEditor.observerFlush();
        this.wysiwyg.teleEditor.historyReset();
    ...
    _onSnippetsLoaded: function (ev) {
        ...
        $themeSelector.on("mouseenter", ".dropdown-item", function (e) {
            ...
            self.wysiwyg.teleEditor.automaticStepSkipStack();
        ...
        $themeSelectorNew.on("click", ".dropdown-item", async (e) => {
            ...
            // the Tele editor before resetting the history.
            setTimeout(() => {
