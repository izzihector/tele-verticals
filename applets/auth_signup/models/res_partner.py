...
from tele import api, exceptions, fields, models, _
...
class ResPartner(models.Model):
    ...
    signup_token = fields.Char(copy=False, groups="base.group_tele_manager")
    signup_type = fields.Char(string='Signup Token Type', copy=False, groups="base.group_tele_manager")
    signup_expiration = fields.Datetime(copy=False, groups="base.group_tele_manager")
