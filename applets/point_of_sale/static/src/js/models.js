...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        loaded: function(self, pos_sessions, tmp){
            ...
            self.pos_session.login_number = tele.login_number;
    ...
    /**
     * Mirror JS method of:
     * _compute_amount in applets/account/models/account.py
     */
    ...
    /**
     * Mirror JS method of:
     * compute_all in applets/account/models/account.py
     *
...
//
// models: [{
//  model: [string] the name of the tele model to load.
...
//  context: [Dict|function] the tele context for the model read
