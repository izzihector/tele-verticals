...
class TestAccountDisallowedExpensesAutomobileReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        batmobile, batpod = cls.env['automobile.vehicle'].create([
            {
                'model_id': cls.env['automobile.vehicle.model'].create({
                    'name': name,
                    'brand_id': cls.env['automobile.vehicle.model.brand'].create({
