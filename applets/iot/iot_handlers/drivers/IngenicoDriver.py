...
from tele.applets.hw_drivers.driver import Driver
from tele.applets.hw_drivers.event_manager import event_manager
from tele.applets.hw_drivers.iot_handlers.interfaces.SocketInterface import socket_devices
...
class IngenicoDriver(Driver):
    ...
    def _action_default(self, data):
        """Action trigered on request from Tele.
        Override
        """
        try:
