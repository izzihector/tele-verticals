...
<t t-set="url" t-value="'www.tele.studio'"/>
<t t-set="httpurl" t-value="'https://www.tele.eu'"/>f
<span>Website0: <a id="url0" t-attf-href="https://www.tele.tz/my/{{object.name}}">https://www.tele.tz/my/<t t-out="object.name"/></a></span>
<span>Website1: <a id="url1" href="https://www.tele.be">https://www.tele.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@tele.studio">test@tele.studio</a></span>
