...
from tele.applets.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from tele.applets.test_mass_mailing.tests.common import TestMassMailCommon
from tele.tests.common import users
from tele.tests import tagged
from tele.tools import formataddr, mute_logger
...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('tele.applets.mass_mailing.models.mailing', 'tele.applets.mail.models.mail_mail', 'tele.applets.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_click(mailing, target_records[0], 'https://www.tele.be')
        self.gateway_mail_click(mailing, target_records[2], 'https://www.tele.be')
        self.gateway_mail_click(mailing, target_records[3], 'https://www.tele.be')
