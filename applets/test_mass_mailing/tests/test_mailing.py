...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            ...
            mailing, recipients,
            mail_links_info=[[
                ('url0', 'https://www.tele.tz/my/%s' % record.name, True, {}),
                ('url1', 'https://www.tele.be', True, {}),
                ('url2', 'https://www.tele.studio', True, {}),
                ('url3', 'https://www.tele.eu', True, {}),
                ...
                ('url7', 'mailto:test@tele.studio', False, {}),
        ...
        # simulate a click
        self.gateway_mail_click(mailing, recipients[0], 'https://www.tele.be')
