...
""",
    ...
    'assets': {
        'mail.assets_discuss_public': [
            'tele_enterprise/static/src/webclient/webclient.scss',
            'mail_enterprise/static/src/components/*/*',
            'mail_enterprise/static/src/models/*/*.js',
            'tele_mobile/static/src/js/core/mixins.js',
            'tele_mobile/static/src/js/core/session.js',
            'tele_mobile/static/src/js/services/core.js',
        ],
        'web.assets_backend': [
