...
class IrTranslation(models.Model):
    ...
    transifex_url = fields.Char("Transifex URL", compute='_get_transifex_url', help="Propose a modification in the official version of Tele")

    def _get_transifex_url(self):
        """ Construct transifex URL based on the module on configuration """
        # e.g. 'https://www.transifex.com/tele/'
        ...
        if not base_url or not tx_sections:
            ...
            # using ini files like '[tele-master.website_sale]'
            ...
            for translation in self:
                ...
                # e.g. https://www.transifex.com/tele/tele-10/translate/#fr/sale/42?q=text:'Sale+Order'
