...
from tele.applets.hr.tests.common import TestHrCommon
from tele.tests import new_test_user, tagged, Form
...
class TestSelfAccessProfile(TestHrCommon):
    ...
    def test_access_my_profile_toolbar(self):
        ...
        john = new_test_user(self.env, login='joh', groups='base.group_tele_manager', name='ERP Manager', email='joh@example.com')
