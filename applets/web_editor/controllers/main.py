...
from tele import http, tools, _, SUPERUSER_ID
...
from tele.tools.image import image_data_uri, base64_to_image
...
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.tele.studio'
