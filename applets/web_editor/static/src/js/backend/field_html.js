tele.define('web_editor.field.html', function (require) {
'use strict';
    ...
    _onLoadWysiwyg: function () {
        ...
        if (this.nodeOptions.cssEdit && this.wysiwyg) {
            ...
            $button.css({
                ...
                position: 'absolute',
                top: '5px',
                [_t.database.parameters.direction === 'rtl' ? 'left' : 'right']: tele.debug && this.nodeOptions.codeview ? '40px' : '5px',
            });
        }
        $container.append($button);
        if (tele.debug && this.nodeOptions.codeview) {
