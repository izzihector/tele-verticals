...
from tele.applets.web_editor.controllers.main import Web_Editor
from tele.applets.web_unsplash.controllers.main import Web_Unsplash
...
class TestImageUploadProgress(tele.tests.HttpCase):
