...
class TestWebsiteResetViews(tele.tests.HttpCase):
    ...
    @mute_logger('tele.applets.http_routing.models.ir_http')
    ...
    # @mute_logger('tele.applets.http_routing.models.ir_http', 'tele.applets.website.models.ir_ui_view')
