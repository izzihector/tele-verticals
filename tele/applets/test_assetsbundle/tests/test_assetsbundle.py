...
from tele import api, http
from tele.applets import __path__ as APPLETS_PATH
from tele.applets.base.models.assetsbundle import AssetsBundle
from tele.applets.base.models.ir_asset import AssetPaths
from tele.applets.base.models.ir_attachment import IrAttachment
from tele.modules.module import get_resource_path, read_manifest
from tele.tests import HttpCase, tagged
from tele.tests.common import TransactionCase
from tele.applets.base.models.qweb import QWebException
from tele.tools import mute_logger, func
...
class AppletManifestPatched(TransactionCase):
    ...
    def tearDown(self):
        ...
        http.applets_manifest = self.__genuine_applets_manifest
    ...
    def setUp(self):
        ...
        self.__genuine_applets_manifest = http.applets_manifest
        http.applets_manifest = func.lazy(lambda: self.manifests)
...
class TestAssetsManifest(AppletManifestPatched):
    ...
    def test_14_other_module(self):
        ...
        self.manifests['test_other'] = {
            ...
            'applets_path': pathlib.Path(__file__).resolve().parent,
            'assets': {
    ...
    @mute_logger('tele.applets.base.models.ir_asset')
    def test_31(self):
    ...
    def test_32(self):
        ...
        files = self.env['ir.asset']._get_asset_paths('test_assetsbundle.irassetsec', applets=self.installed_modules, xml=False)
