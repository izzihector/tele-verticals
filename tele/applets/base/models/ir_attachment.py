...
from tele.exceptions import AccessError, ValidationError, MissingError, UserError
from tele.tools import config, human_size, ustr, html_escape, ImageProcess, str2bool
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any telecms document.
