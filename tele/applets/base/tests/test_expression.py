...
from tele.applets.base.tests.common import SavepointCaseWithUserDemo
from tele.fields import Date
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('tele.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have Tele has a parent company, you expect to find,
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [Command.create({'name': 'address of Tele Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
