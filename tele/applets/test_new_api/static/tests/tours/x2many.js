tele.define('web.test.x2many', function (require) {
    'use strict';
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        trigger: 'tr:has(td:containsExact(Tele Demo)) .o_list_record_selector input[type="checkbox"]',
    }, {
        content: "save selected participants",
        trigger: '.o_select_button',
        extra_trigger: 'tr:has(td:containsExact(Tele Demo)) .o_list_record_selector input[type="checkbox"]:propChecked',
    }, { // save
        content: "save discussion",
        trigger: 'button.o_form_button_save',
        ...
        trigger: '.ui-autocomplete li:contains(Tele Demo)',
        in_modal: false,
    }, {
        content: "test one2many's line onchange after many2one",
        trigger: '.o_field_widget:contains([test_trigger] Tele Demo)',
        run: function () {}, // it's a check
    }, {
        ...
        trigger: '.o_content:has(.tab-pane:eq(0) .o_field_widget tbody tr td.o_readonly_modifier:contains([test_trigger] Tele Demo))',
        run: function () {}, // it's a check
    }, {
        content: "test one2many triggered the onchange on save",
        trigger: 'textarea[name="message_concat"]:first:propValueContains([test_trigger] Tele Demo:e)',
        run: function () {}, // don't change texarea content
    }, { // remove
        content: "remove b",
        ...
        content: "select demo user",
        trigger: '.ui-autocomplete li a:contains(Tele Demo)',
        in_modal: false,
    }, {
        content: "test one2many's line onchange after many2one",
        trigger: '.o_field_widget:contains([test_trigger] Tele Demo)',
...

    {
        ...
        content: "test one2many's line onchange after many2one",
        trigger: '.o_list_view td:contains([test_trigger2] Tele Demo)',
        run: function () {}, // don't blur the many2one
    }, {
        content: "change text value",
        trigger: 'textarea[name="body"]:first',
        ...
        trigger: 'textarea[name="message_concat"]:first:propValueContains([test_trigger2] Tele Demo:ccccc)',
        run: function () {}, // don't change texarea content
    }, {
        content: "click outside to trigger one2many onchange",
