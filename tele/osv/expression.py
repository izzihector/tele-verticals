...
term representation was ['=', 'company_id.name', 'Tele']. Used in a
...
Tele will use the SQL function 'unaccent' when available for the
...
Finally, to instruct Tele to really use the unaccent function, you have to
...
import tele.modules
from tele.osv.query import Query, _generate_table_alias
...
def get_unaccent_wrapper(cr):
    if tele.registry(cr.dbname).has_unaccent:
